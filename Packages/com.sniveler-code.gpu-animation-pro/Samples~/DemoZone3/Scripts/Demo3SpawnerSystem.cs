...
{
    // todo: Heavy SyncPoint -> PoolingSystem
        ...
        public partial struct ProgressJob : IJobEntity
        {
                ...
                ref Demo3SpawnerData data)
            {
                ...
                for (int i = 0; i < entities.Length; i++)
                {
                    ...
                    CommandBuffer.AddComponent(index, entity, new Demo3HealthData {Value = 100f});
                    CommandBuffer.SetComponent(index, entity, new Demo3CombatData
                    {
                        ...
                        LockedCellX = -1,
                        LockedCellY = -1,
                        CurrentTargetGpuIndex = -1
                    });

                    // offset trick
                    CommandBuffer.SetComponent(index, entity, new AnimatorData
                    {
                        Index = AnimatorGuardMelee.GreatSwordRun,
